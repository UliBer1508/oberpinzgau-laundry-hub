...
import { type ManagementBestellung, useUpdateWaeschekraft, useUpdateManagementStatus, useUpdatePrioritaet, useUpdateBearbeitungDeadline } from "@/hooks/useManagementBestellungen";
